          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-lg mb-8 font-inter font-regular">
                Holistic-корм для собак с чувствительным желудком.Натуральный состав, минимальное содержание зерновых и контроль качества на каждом этапе производства.
              </p>
