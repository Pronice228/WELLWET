      ...
      <div className=" rounded-[40px] flex flex-col md:flex-row">
        ...
        <div className="md:w-3/5 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
          ...
          <p className="text-slate-600 mb-10">
            Мы поможем помочь с выбором корма и ответим на вопросы о продукции WellWet.
          </p>
          <form className="space-y-8 w-full">
            ...
            <button
              type="submit"
              className=" bg-[#dd9799] text-white px-8 py-3 rounded-full font-bold items-center gap-2 shadow-lg flex flex-row">
