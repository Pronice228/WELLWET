  ...
  return (
    ...
    <div className="min-h-screen bg-white font-sans text-[#333]">
      ...
      <main className="max-w-7xl mx-auto px-4 py-10">
        <h1 className="text-3xl font-bold mb-8">Каталог всех товаров</h1>
        
        <div className="flex gap-3 mb-10">
          <button className="px-5 py-2 bg-[#ecebbd] text-[#00838f] rounded-full text-[13px] font-bold">Все корма</button>
  ...
  return (
    <div className="bg-white rounded-sm flex flex-col items-center p-2 group">
      ...
      <div className="w-full text-left">
        ...
        <p className="text-gray-400 text-[11px] mt-1 ">Для собак с чувствительным желудком</p>
        <button onClick={() => window.location.href = '/Card'} className="w-full mt-4 bg-[#ce6e3b]  text-white py-2 rounded-md text-[13px] font-medium ">
          Проверить
        </button>
